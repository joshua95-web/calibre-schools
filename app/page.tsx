              ...
              <div className="relative px-6 py-32 sm:py-40 lg:px-8 lg:py-56 lg:pr-0">
                <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                  ...
                  <div className="mt-10 flex items-center gap-x-6">
                    <div className="rounded-md bg-calibre-citrus px-3.5 py-2.5 text-lg text-white shadow-sm hover:bg-amber-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-fuchsia-600">
                      <SignInButton />
                    </div>
                    <div className="rounded-md bg-calibre-citrus px-3.5 py-2.5 text-lg text-white shadow-sm hover:bg-amber-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-fuchsia-600">
                      <SignUpButton />
